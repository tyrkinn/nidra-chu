...
export function Meditation({ size = "100%", className }: IllustrationProps) {
  return (
    ...
    >
      ...
      {/* head */}
      <circle cx="100" cy="68" r="12" fill="#c7a09e" fillOpacity="0.7" stroke="currentColor" strokeOpacity="0.4" strokeWidth="0.8" />
      ...
      {/* knees */}
      <circle cx="62" cy="148" r="6" fill="#7a6c9b" fillOpacity="0.7" />
      <circle cx="138" cy="148" r="6" fill="#7a6c9b" fillOpacity="0.7" />
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="100" cy="138" r="2.4" fill="#f5e9d8" />

      {/* third eye dot */}
      <circle cx="100" cy="66" r="1.6" fill="#f5e9d8" />
    </svg>
  );
}
