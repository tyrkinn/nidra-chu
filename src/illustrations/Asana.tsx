...
export function Asana({ size = "100%", className }: IllustrationProps) {
  return (
    ...
    >
      ...
      {/* tree pose — head */}
      <circle cx="100" cy="44" r="10" fill="var(--accent-soft)" fillOpacity="0.7" stroke="currentColor" strokeOpacity="0.4" strokeWidth="0.8" />
      ...
      >
        ...
        <path d="M86 30 Q100 16 114 30" fill="var(--accent-glow)" fillOpacity="0.8" />
